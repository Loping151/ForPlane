config = {
    'description': 'full version 7min with xyzt blob encoding and isg-ist on tearing dataset',

    'expname': 'full_2000_tearing_notimes',
    'logdir': './logs/aba/notimes',
    'device': 'cuda:0',

    'data_downsample': 1.0,
    'data_dirs': ['data/endonerf_full_datasets/tearing_tissues'],
    'contract': False,
    'ndc': True,
    'ndc_far': 2.0,
    'isg': True,
    ...
    'time_smoothness_weight': 0.00,
    'time_smoothness_weight_proposal_net': 0.0000,
